...
<div class="header-container">
  ...
  <div id="header" style="background-color: #373636;">

    <h2 style="color: white;position: absolute">
      <a href="dashboard.html" style="color:white; margin-left: 25px; font-size: 18px; margin-top: 56px">Registration Portal</a>
    </h2>
    ...
    <ul class="nav">
      <li class="dropdown" id="profile-messages">
        <a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i
                class="icon icon-user"></i> <span class="text">Student</span><b class="caret"></b></a>
...
<div id="sidebar">
  <ul>
    ...
    <li class="submenu"><a href="#" class="nav-bar" onmouseover="this.style.backgroundColor=' #090909';" onmouseout="this.style.backgroundColor='#292828';"><i class="icon icon-th-list"></i> <span>Navigate</span> <span
  ...
  <div class="profile-picture" style="margin-top: 190%; padding-left: 25%;">
    <a href="profile.php">
      <img src="./img/icons/profile_icon.jpg" style="border-radius: 50%;" height="80px" width="80px" class="profile-icon" alt="">
    </a>
  </div>
</div>
...
<!--sidebar-menu-->
<div id="search">
  <div class="logo-container"><img src="./img/uenr_logo-removebg-preview.png" width="40px" height="4px" alt="" class="logo"></div>
  <div id="school-name"><h5 style="color: rgb(168, 166, 166);">University of Energy and Natural Resources</h2></div>
...
<!--Footer-part-->
<!-- <div class="row-fluid">
  <div id="footer" class="span12" style="color: white"> Designed And Developed By: YourName</div>
</div> -->
<!--end-Footer-part--> 
